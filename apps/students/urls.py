...
urlpatterns = [
    ...
    path('suivi/',              views.student_tracking,       name='suivi'),
    path('suivi/absences/',     views.tracking_absences,      name='suivi-absences'),
    path('suivi/observations/', views.tracking_observations,  name='suivi-observations'),
